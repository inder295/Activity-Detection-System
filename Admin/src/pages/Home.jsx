...
const Home = () => {
  ...
  const deliveredCount=parcels.filter(parcel=>parcel.stauts===3).length;
  const pendingCount=parcels.filter(parcel=>parcel.stauts===1).length;
  ...
  return (
    <div>
      ...
      <div className="h-[350px] w-[350px] shadow-lg p-[20px] ">
